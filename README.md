...
The origin of the name 'Servant Salamander': It was back in 1997, when Petr Šolín and his friend Pavel Schreib were in their room brainstorming name for this project. At that time, the well-known programs were the aging Norton Commander and the rising Windows Commander. They questioned why a file manager should be named 'Commander', which implied that it commanded instead of served. This thought led to the birth of the name 'Servant Salamander'.
