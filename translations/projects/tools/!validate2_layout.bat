@rem Validate layout for all modules - reports all failures.
...
@echo.
@if %all_sal_trl_modules_validated% equ 1 @echo All validated module layouts are OK.
@if %all_sal_trl_modules_validated% equ 0 @echo Layout validation FAILED for at least one module.
@echo.
