...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_MENU_EDIT_PASTE, MNTS_B | MNTS_I | MNTS_A, CM_CLIPPASTE, IDX_TB_CLIPBOARDPASTE, 0, &EnablerPaste}, // !ATTENTION! !WARNING!, the item is modified in CMainWindow/WM_USER_INITMENUPOPUP (when there is text on the clipboard, "Change Directory" is added)
        ...
        {MNTT_IT, IDS_MENU_OPT_VSB_TREE, MNTS_B | MNTS_I | MNTS_A, CM_TOGGLETREEVIEW, -1, 0, NULL},
...
MENU_TEMPLATE_ITEM ArchivePanelMenuTemplate[] =
    {
        {MNTT_PB, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_ARCHIVEMENU_CLIPPASTE, MNTS_B | MNTS_I | MNTS_A, CM_CLIPPASTE, IDX_TB_CLIPBOARDPASTE, 0, &EnablerPaste}, // !ATTENTION!, the item is modified in ShellAction()/saContextMenu/onlyPanelMenu (when there is text on the clipboard, "Change Directory" is added)
        {MNTT_PE},                                                                                                             // terminator
};
