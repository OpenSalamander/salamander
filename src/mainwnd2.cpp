...
// 6 = 1.6b4.x
// 7 = 1.6b5.x          needed for proper conversion of supported plugin functions (see CPlugins::Load)
// 8 = 1.6b5.x          review again to be safe ;-)
// 9 = 1.6b5.x          because of switching from the EXE name to a variable for custom packers
// 10 = 1.6b6           due to renaming "XXX (Internal)" to "XXX (Plugin)" in the Pack and Unpack dialogs
//                      and to setting the ANSI version of the "list of files" file also for the ACE32 and PKZIP25 (un)packers
// 11 = 1.6b7           added the CheckVer plugin - ensure automatic installation
// 12 = 2.0             auto-close salopen.exe + added the PEViewer plugin - ensure automatic installation
// 13 = 2.5b1           added the missing conversion of custom packer configuration - reflect the change for LHA
// 14 = 2.5b1           new Advanced Options in the Find dialog. Switched to CFilterCriteria. Converted the inverse filter mask.
// 15 = 2.5b2           newer version so that plugins load (upgrade registry entries)
// 16 = 2.5b2           added coloring of Encrypted files and directories (added when loading the configuration + included in the default configuration)
// 17 = 2.5b2           added the *.xml mask to the internal viewer settings - "force text mode"
// 18 = 2.5b3           only to transfer plugin configuration from version 2.5b2
// 19 = 2.5b4           only to transfer plugin configuration from version 2.5b3
// 20 = 2.5b5           only to transfer plugin configuration from version 2.5b4
// 21 = 2.5b6           only to transfer plugin configuration from version 2.5b5(a)
