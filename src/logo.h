...
void SplashScreenCloseIfExist();                   // if the window exists, closes it
...
void IfExistSetSplashScreenText(const char* text); // if it exists, sets the text which will be displayed immediately
