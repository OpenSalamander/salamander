...
// volatile pointer to the name of the infotype. Allocated by call. Caller responsible for freeing
    ...
    {
        int cbStruct;             // size of this structure
// volatile pointer to the category name
// volatile pointer to the category description
...
// IN: flags controlling the appearance of the toolbar
