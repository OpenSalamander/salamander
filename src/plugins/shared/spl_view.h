...
public:
    ...
    // if 'returnLock' is FALSE, 'lock' and 'lockOwner' are ignored; if 'returnLock' is
    ...
    // ViewFile call returns; if 'viewerData' is not NULL, it passes extended viewer parameters (see
    ...
    // 'lockOwner' are ignored in that case)
