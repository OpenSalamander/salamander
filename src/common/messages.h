...
// Returns a pointer to a global buffer containing the resource string
const char* rsc(int resID);
const WCHAR* rscW(int resID);

// Returns a pointer to a global buffer containing the sprintf output
...
// Sets the title for both versions (ANSI + Unicode)
void SetMessagesTitle(const char* title);
void SetMessagesTitleW(const WCHAR* title);

// Sets the parent window for message boxes generated by the MESSAGExx macros
...
// MESSAGE_I requires MESSAGES_DEBUG to be defined
...
// MESSAGE_Q requires MESSAGES_DEBUG to be defined
