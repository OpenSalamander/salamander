...
//#define NSVG_USESSE2
	...
	__m128i const255 = _mm_set1_epi16(255);
	__m128i constCA = _mm_set1_epi16((short)ca);
	__m128i constC = _mm_set_epi16(0, (short)cb, (short)cg, (short)cr, 0, (short)cb, (short)cg, (short)cr);

	for (i = 0; i < count / 4; i++) {
		//int a = nsvg__div255((int)cover[0] * ca);
		__m128i cover_ca = _mm_mullo_epi16(_mm_unpacklo_epi8(_mm_cvtsi32_si128(*(const int*)cover), const0), constCA);
		...
		//int ia = 255 - a;
		__m128i ia = _mm_sub_epi16(const255, a);
