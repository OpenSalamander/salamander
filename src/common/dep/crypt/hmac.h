...
#define sha1_begin(ctx)           SHA1Init(ctx)
#define sha1_hash(buf, len, ctx)  SHA1Update(ctx, buf, len)
#define sha1_end(dig, ctx)        SHA1Final(dig, ctx)

// END OF OPENSAL MODIFICATION
