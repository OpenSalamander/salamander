...
/* This implementation of SHA1-1 was written by 
   ...
   the good faith that it is public domain */
...
int hash_update_sha1(void * ctx, unsigned char *buf, unsigned int len)
{
...
void SHA1Update(SHA1_CTX* context, const unsigned char * data, unsigned int len)
{
  ...
  if ((j + len) > 63) 
  {
    ...
    for ( ; i + 63 < len; i += 64) {
      /* BEGIN OF OPENSAL MODIFICATION !!!!!!!!!!!!!!!! */
      /* Prevent the code from modifying the contents of data */
